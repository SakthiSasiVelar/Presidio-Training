...
namespace RequestTrackerModelLibrary
{
    public class RequestTrackerContext:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=18RBBX3\INSTANCE;Integrated Security=true;Initial Catalog=dbEmployeeTracker;");
        }
        public DbSet<Employee> Employees { get; set; }
        public DbSet<Request> Requests { get; set; }
        public DbSet<SolutionRequest> Solutions { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SolutionRequest>().HasKey(sr => sr.SolutionId);
            ...
            modelBuilder.Entity<SolutionRequest>()
